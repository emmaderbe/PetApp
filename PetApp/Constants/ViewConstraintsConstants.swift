...
enum ViewConstraintsConstants {
    ...
    // detail view
    enum DetailViewConstraints {
        static let generalTop: CGFloat = 20
    ...
    enum FoodViewConstraints {
        ...
        static let indicatorSpacing: CGFloat = 22
    ...
    enum ProductContentUnavailableConstraints {
