...
extension CardViewController {
    private func initializeCardData() {
        cardData = [
            CardModel(identifier: StringConstants.CardView.idDevCardData, 
                      title: NSLocalizedString("titleDevCardData", comment: ""),
                      description: NSLocalizedString("descriptionDevCardData", comment: ""),
                      profileURL: StringConstants.CardView.profileURLDev),
            CardModel(identifier: StringConstants.CardView.idDocCardData, 
                      title: NSLocalizedString("titleDocCardData", comment: ""),
                      description: NSLocalizedString("descriptionDocCardData", comment: ""),
                      profileURL: StringConstants.CardView.profileURLDoc),
            CardModel(identifier: StringConstants.CardView.idDesCardData, 
                      title:
                        NSLocalizedString("titleDesCardData", comment: ""),
                      description: NSLocalizedString("descriptionDesCardData", comment: ""),
                      profileURL: StringConstants.CardView.profileURLDes),
        ]
...
extension CardViewController {
    private func setupCards() {
        for card in cardData {
            ...
            cardView.setupData(image: UIImage(named: card.identifier) ?? UIImage(), title: card.title, description: card.description)
